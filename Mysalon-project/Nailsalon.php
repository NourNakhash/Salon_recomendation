...
<nav>
         ...
         <ul>
         <li><a  href="customerpage.php"  style='color:black; text-decoration:none;'>My Account</a></li>
      
            <li>
               <a class="active" href="#"  style='color:black; text-decoration:none;'>Salons
               <i class="fas fa-caret-down"></i>
               </a>
               <ul>
                  <li><a href="beauty-salon.php"  style='color:black; text-decoration:none;'>Beauty</a></li>
                  <li><a href="barber.php" style='color:black; text-decoration:none;'>Braber</a></li>
                  <li><a href="Spasalon.php" style='color:black; text-decoration:none;'>Spa</a></li>
                  <li><a href="Nailsalon.php" style='color:black; text-decoration:none;'>Nails</a></li>
                  <li><a href="Hairsalon.php" style='color:black; text-decoration:none;'>Hair</a></li>
               </ul>
            </li>
    ...
    <table class="content-table" id="branch">
        ...
        cast(OpeningTime as varchar(5)) as OpeningTime,cast(ClosingTime as varchar(5)) AS ClosingTime,Phonenumber,Rating  FROM salon WHERE ServiceId =3";
