...
<nav>
         ...
         <li><a href="customerpage.php" style='color:black;'>My Account</a></li>
            ...
            <li><a href="recommed-form.php" style='color:black;'>My recommendation</a></li>
    ...
    <table class="content-table" id="branch">
        ...
        cast(OpeningTime as varchar(5)) as OpeningTime,cast(ClosingTime as varchar(5)) AS ClosingTime,Phonenumber,Rating  FROM salon WHERE ServiceId =5";
